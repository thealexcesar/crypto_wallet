...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acronym: @coin.acronym, coin_name: @coin.coin_name, url_image: @coin.url_image } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronym: @coin.acronym, coin_name: @coin.coin_name, url_image: @coin.url_image } }
