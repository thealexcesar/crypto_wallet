...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acromym: @coin.acromym, description: @coin.description, url_image: @coin.url_image } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acromym: @coin.acromym, description: @coin.description, url_image: @coin.url_image } }
